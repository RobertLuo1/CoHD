...
class VisualNounAlighment(nn.Module):
    ...
    def forward(self, tgt, memory, memory_key_padding_mask: Optional[Tensor] = None,
...
class MSDeformAttnPixelDecoder(nn.Module):
    ...
    def forward_features(self, features, noun_feat=None):
        srcs = []
        pos = []
